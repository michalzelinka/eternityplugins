...
// -----------------------------------------------------------------------------
//
// File name      : $URL: https://miranda.svn.sourceforge.net/svnroot/miranda/trunk/miranda/protocols/IcqOscarJ/chan_04close.cpp $
...
int CIcqProto::connectNewServer(serverthread_info *info)
{
	...
	if (!m_bGatewayMode)
	{
		{ /* Time to release packet receiver, connection already closed */
			...
			NetLib_CloseConnection(&info->hPacketRecver, FALSE); // TODO: why? oO
