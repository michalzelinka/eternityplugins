...
// -----------------------------------------------------------------------------
//
// File name      : $URL: https://miranda.svn.sourceforge.net/svnroot/miranda/trunk/miranda/protocols/IcqOscarJ/log.cpp $
// Revision       : $Revision: 8481 $
// Last change on : $Date: 2008-10-31 15:43:07 +0100 (Fri, 31 Oct 2008) $
...
static const char *szLevelDescr[] = {LPGEN("ICQ Note"), LPGEN("ICQ Warning"), LPGEN("ICQ Error"), LPGEN("ICQ Fatal"), LPGEN("ICQ Critical")};
