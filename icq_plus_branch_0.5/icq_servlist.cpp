...
// -----------------------------------------------------------------------------
//
// File name      : $URL: https://miranda.svn.sourceforge.net/svnroot/miranda/trunk/miranda/protocols/IcqOscarJ/icq_servlist.cpp $
...
void CIcqProto::ResetUserSSISettings(HANDLE hContact)
{
	...
	setSettingWord(hContact, "Auth", 0);
}
