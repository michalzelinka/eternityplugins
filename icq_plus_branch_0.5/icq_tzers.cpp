...
static BOOL CALLBACK SendTzerDlgProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	int selection = 0;
	SendTzerDlgParam* dat = (SendTzerDlgParam*)GetWindowLong(hwndDlg, GWL_USERDATA);
