...
static BOOL CALLBACK FilterWndProc(HWND hwndDlg, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	switch (uMsg) {
      ...
      // eternity : translation hack (temporarily?)
      SetDlgItemText( hwndDlg, IDC_1, TranslateT( "Actions" ) );
      SetDlgItemText( hwndDlg, IDC_2, TranslateT( "Messages" ) );
      SetDlgItemText( hwndDlg, IDC_3, TranslateT( "Nick changes" ) );
      SetDlgItemText( hwndDlg, IDC_4, TranslateT( "Users joining" ) );
      SetDlgItemText( hwndDlg, IDC_5, TranslateT( "Users leaving" ) );
      SetDlgItemText( hwndDlg, IDC_6, TranslateT( "Topic changes" ) );
      SetDlgItemText( hwndDlg, IDC_7, TranslateT( "Status changes" ) );
      SetDlgItemText( hwndDlg, IDC_8, TranslateT( "Information" ) );
      SetDlgItemText( hwndDlg, IDC_9, TranslateT( "Disconnects" ) );
      SetDlgItemText( hwndDlg, IDC_10, TranslateT( "User kicks" ) );
      SetDlgItemText( hwndDlg, IDC_11, TranslateT( "Notices" ) );
      SetDlgItemText( hwndDlg, IDC_TEXTO, TranslateT( "  Show these events" ) );
      // eternity : translation hack - END
			break;
		}
