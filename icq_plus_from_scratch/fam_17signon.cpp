...
// -----------------------------------------------------------------------------
//
// File name      : $URL: https://miranda.svn.sourceforge.net/svnroot/miranda/trunk/miranda/protocols/IcqOscarJ/fam_17signon.cpp $
...
void CIcqProto::handleAuthorizationFam(unsigned char *pBuffer, WORD wBufferLength, snac_header* pSnacHeader, serverthread_info *info)
{
	...
	case ICQ_SIGNON_REG_AUTH_IMAGE:
		// TODO: handleRegImage(pBuffer, wBufferLength, info);
		break;

	case ICQ_SIGNON_NEW_UIN:
		// TODO: handleIcqNewUin(pBuffer, wBufferLength, info);
		break;
