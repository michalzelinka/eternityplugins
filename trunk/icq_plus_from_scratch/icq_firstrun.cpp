...
// -----------------------------------------------------------------------------
//
// File name      : $URL: https://miranda.svn.sourceforge.net/svnroot/miranda/trunk/miranda/protocols/IcqOscarJ/icq_firstrun.cpp $
// Revision       : $Revision: 8058 $
// Last change on : $Date: 2008-07-17 21:12:29 +0200 (Thu, 17 Jul 2008) $
...
BOOL CALLBACK icq_FirstRunDlgProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDC_REGUIN:
			// TODO: ppro->ShowRegUINDialog(hwndDlg);
			break;
