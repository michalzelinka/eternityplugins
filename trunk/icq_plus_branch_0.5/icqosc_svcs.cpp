...
// -----------------------------------------------------------------------------
//
// File name      : $URL: https://miranda.svn.sourceforge.net/svnroot/miranda/trunk/miranda/protocols/IcqOscarJ/icqosc_svcs.cpp $
...
INT_PTR CIcqProto::AddServerContact(WPARAM wParam, LPARAM lParam)
{
  ...
  { /// TODO: remove possible 0x6A TLV in contact server-list data!!!
		...
		if (getSettingByte((HANDLE)wParam, "CheckSelfRemove", 0))
			setSettingByte((HANDLE)wParam, "CheckSelfRemove", 0); // TODO: ??
	}
	return 0;
}
