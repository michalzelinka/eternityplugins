...
$Id: templates.c 4628 2007-01-19 05:23:54Z nightwish2004 $
...
char *TemplateNames[] = {
    ...
    "Status change",
    "Error message"
}; // eternity TODO - but translated in german release?
    ...
    switch (msg) {
        ...
        case WM_DRAWITEM:
        {
            ...
            if (dis->itemState & ODS_SELECTED) {
                ...
                TextOutA(dis->hDC, dis->rcItem.left, dis->rcItem.top, Translate(TemplateNames[iItem]), lstrlenA(Translate(TemplateNames[iItem]))); //eternity #201
				}
            return TRUE;
        }
