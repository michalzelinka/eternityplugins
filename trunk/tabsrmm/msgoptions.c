...
$Id: msgoptions.c 6511 2007-10-03 13:20:12Z nightwish2004 $
...
// eternity mod #24
      CheckDlgButton(hwndDlg, IDC_TYPINGSOUND, DBGetContactSettingByte(NULL, SRMSGMOD_T, SRMSGSET_MOD_TYPINGSOUND, SRMSGDEFSET_MOD_TYPINGSOUND));
// eternity mod #24 (end)
...
// eternity mod #24
					DBWriteContactSettingByte(NULL, SRMSGMOD_T, SRMSGSET_MOD_TYPINGSOUND, (BYTE)IsDlgButtonChecked(hwndDlg, IDC_TYPINGSOUND));
// eternity mod #24 (end)
