...
$Id: msgdialog.c 6581 2007-10-14 00:48:31Z nightwish2004 $
*/
...
char *xStatusDescr[] = { "Angry", "Taking a bath", "Tired", "Party", "Drinking beer", "Thinking", "Eating", "Watching TV",
                         "Meeting", "Coffee", "Listening to music", "Business", "Shooting", "Having fun", "On the phone",
                         "Gaming", "Studying", "Shopping", "Feeling sick", "Sleeping", "Surfing", "Browsing", "Working",
                         "Typing", "Picnic", "Cooking", "Smoking", "I am High", "On WC", "To be or not to be",
                         "Watching pro7 on TV", "Love", "Searching", "Love", "Journal", "Sex", "Smoking" };
            ...
            if(wParam == VK_RETURN) {
                if (isShift) {
                    if(myGlobals.m_SendOnShiftEnter) {
                        ...
                        /* break; OLD SOLUTION */
                        { SkinPlaySound("TypingBell"); break; } /* eternity mod #24 NEW SOLUTION */
                }
