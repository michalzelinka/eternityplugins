...
$Id: container.c 6512 2007-10-03 16:32:44Z nightwish2004 $
*/
...
static TCHAR *menuBarNames[] = {_T("File"), _T("View"), _T("Message Log"), _T("Container"), _T("Help") }; // eternity
static TCHAR *menuBarNames_translated[5]; // eternity: original repo : 6
