...
HANDLE hExtraXStatus = NULL, hExtraDC = NULL, hExtraqipstatus = NULL;
...
PLUGININFOEX pluginInfo = {
  ...
  0,
  "J.Kucera, Bio, M.berg, R.Hughes, Jon Keating, Faith, S7, BM, sss, jarvis, chaos.persei, ghazan, baloo, nullbie etc",
  "sss123next@list.ru, chaos.persei@gmail.com, sin@miranda-me.org, jokusoftware@miranda-im.org",
  "(C) 2000-2009 M. berg, R.Hughes, J.Keating, Bio, J.Kucera, Angeli-Ka, Faith Healer, chaos.persei, Se7ven, BM, sss, [sin], nullbie and others",
...
__declspec(dllexport) PLUGININFOEX* MirandaPluginInfoEx(DWORD mirandaVersion)
{
  ...
  if (_mirandaVersion < PLUGIN_MAKE_VERSION(0, 7, 0, 44)) 
  {
    MessageBox( NULL, "ICQ plugin cannot be loaded. It requires Miranda IM 0.7.0.44 or later.", "ICQ Plugin", 
...
int __declspec(dllexport) Load(PLUGINLINK *link)
{
  ...
  hIconFolder = FoldersRegisterCustomPath(gpszICQProtoName, "Icons", MIRANDA_PATH"\\icons");
...
static int OnModulesLoaded(WPARAM wParam, LPARAM lParam)
{
	...
	if(ServiceExists(MS_UPDATE_REGISTER))   
	{
		...
		upd.szBetaUpdateURL = upd.szUpdateURL = "http://sss.chaoslab.ru:81/icq.zip";
		upd.szBetaVersionURL = upd.szVersionURL = "http://sss.chaoslab.ru:81/icqpluscurrent";
		upd.pbBetaVersionPrefix = upd.pbVersionPrefix = "icq ";
