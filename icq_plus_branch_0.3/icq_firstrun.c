...
BOOL CALLBACK DlgProcAccMgrUI(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam);
      ...
      case IDOK:
        {
          ...
          GetDlgItemText(hwndDlg, IDC_PW, str, 9);
...
{
	return (int)CreateDialogUtf(hInst, MAKEINTRESOURCE(IDD_ACCMGRUI), (HWND)lParam, DlgProcAccMgrUI);
}
BOOL CALLBACK DlgProcAccMgrUI(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
  switch (msg)
