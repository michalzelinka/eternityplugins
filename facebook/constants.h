...
// Version management
#include "build.h"
#define __VERSION_DWORD             PLUGIN_MAKE_VERSION(0, 1, 1, 1)
#define __PRODUCT_DWORD             PLUGIN_MAKE_VERSION(0, 8, 0, 34)
#define __VERSION_STRING            "0.1.1.1"
#define __PRODUCT_STRING            "0.8.0.34"
#define __VERSION_VS_FILE           0,1,1,1
#define __VERSION_VS_PROD           0,8,0,34
#define __VERSION_VS_FILE_STRING    "0, 1, 1, 1"
