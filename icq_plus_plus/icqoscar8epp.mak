# Microsoft Developer Studio Generated NMAKE File, Based on icqoscar8epp.dsp
!IF "$(CFG)" == ""
CFG=icqoscar8epp - Win32 Debug
!MESSAGE No configuration specified. Defaulting to icqoscar8epp - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "icqoscar8epp - Win32 Release" && "$(CFG)" != "icqoscar8epp - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "icqoscar8epp.mak" CFG="icqoscar8epp - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "icqoscar8epp - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "icqoscar8epp - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
!IF  "$(CFG)" == "icqoscar8epp - Win32 Release"
...
ALL : "..\..\bin\release\plugins\ICQ.dll" "$(OUTDIR)\icqoscar8epp.bsc"
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /Zi /O1 /I "../../include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "icqoscar8epp_EXPORTS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\icqoscar8epp.pch" /Yu"icqoscar.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\icqoscar8epp.bsc" 
BSC32_SBRS= \
...
"$(OUTDIR)\icqoscar8epp.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
...
!ELSEIF  "$(CFG)" == "icqoscar8epp - Win32 Debug"
...
ALL : "..\..\bin\debug\plugins\ICQ.dll" "$(OUTDIR)\icqoscar8epp.bsc"
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "icqoscar8epp_EXPORTS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\icqoscar8epp.pch" /Yu"icqoscar.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
!IF EXISTS("icqoscar8epp.dep")
!INCLUDE "icqoscar8epp.dep"
!ELSE 
!MESSAGE Warning: cannot find "icqoscar8epp.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\chan_01login.obj"	"$(INTDIR)\chan_01login.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\chan_02data.c

"$(INTDIR)\chan_02data.obj"	"$(INTDIR)\chan_02data.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\chan_03error.c

"$(INTDIR)\chan_03error.obj"	"$(INTDIR)\chan_03error.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\chan_04close.c

"$(INTDIR)\chan_04close.obj"	"$(INTDIR)\chan_04close.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\chan_05ping.c

"$(INTDIR)\chan_05ping.obj"	"$(INTDIR)\chan_05ping.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_01service.c

"$(INTDIR)\fam_01service.obj"	"$(INTDIR)\fam_01service.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_02location.c

"$(INTDIR)\fam_02location.obj"	"$(INTDIR)\fam_02location.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_03buddy.c

"$(INTDIR)\fam_03buddy.obj"	"$(INTDIR)\fam_03buddy.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_04message.c

"$(INTDIR)\fam_04message.obj"	"$(INTDIR)\fam_04message.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_09bos.c

"$(INTDIR)\fam_09bos.obj"	"$(INTDIR)\fam_09bos.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_0alookup.c

"$(INTDIR)\fam_0alookup.obj"	"$(INTDIR)\fam_0alookup.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_0bstatus.c

"$(INTDIR)\fam_0bstatus.obj"	"$(INTDIR)\fam_0bstatus.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_13servclist.c

"$(INTDIR)\fam_13servclist.obj"	"$(INTDIR)\fam_13servclist.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_15icqserver.c

"$(INTDIR)\fam_15icqserver.obj"	"$(INTDIR)\fam_15icqserver.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\fam_17signon.c

"$(INTDIR)\fam_17signon.obj"	"$(INTDIR)\fam_17signon.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\directpackets.c

"$(INTDIR)\directpackets.obj"	"$(INTDIR)\directpackets.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_direct.c

"$(INTDIR)\icq_direct.obj"	"$(INTDIR)\icq_direct.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_directmsg.c

"$(INTDIR)\icq_directmsg.obj"	"$(INTDIR)\icq_directmsg.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_filerequests.c

"$(INTDIR)\icq_filerequests.obj"	"$(INTDIR)\icq_filerequests.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_filetransfer.c

"$(INTDIR)\icq_filetransfer.obj"	"$(INTDIR)\icq_filetransfer.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_advsearch.c

"$(INTDIR)\icq_advsearch.obj"	"$(INTDIR)\icq_advsearch.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_db.c

"$(INTDIR)\icq_db.obj"	"$(INTDIR)\icq_db.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icqosc_svcs.c

"$(INTDIR)\icqosc_svcs.obj"	"$(INTDIR)\icqosc_svcs.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\init.c

"$(INTDIR)\init.obj"	"$(INTDIR)\init.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\log.c

"$(INTDIR)\log.obj"	"$(INTDIR)\log.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\UI\askauthentication.c

"$(INTDIR)\askauthentication.obj"	"$(INTDIR)\askauthentication.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\icq_firstrun.c

"$(INTDIR)\icq_firstrun.obj"	"$(INTDIR)\icq_firstrun.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_opts.c

"$(INTDIR)\icq_opts.obj"	"$(INTDIR)\icq_opts.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_popups.c

"$(INTDIR)\icq_popups.obj"	"$(INTDIR)\icq_popups.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_uploadui.c

"$(INTDIR)\icq_uploadui.obj"	"$(INTDIR)\icq_uploadui.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\UI\loginpassword.c

"$(INTDIR)\loginpassword.obj"	"$(INTDIR)\loginpassword.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\UI\userinfotab.c

"$(INTDIR)\userinfotab.obj"	"$(INTDIR)\userinfotab.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\changeinfo\constants.c

"$(INTDIR)\constants.obj"	"$(INTDIR)\constants.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\changeinfo\db.c

"$(INTDIR)\db.obj"	"$(INTDIR)\db.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\changeinfo\dlgproc.c

"$(INTDIR)\dlgproc.obj"	"$(INTDIR)\dlgproc.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\changeinfo\editlist.c

"$(INTDIR)\editlist.obj"	"$(INTDIR)\editlist.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\changeinfo\editstring.c

"$(INTDIR)\editstring.obj"	"$(INTDIR)\editstring.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\changeinfo\main.c

"$(INTDIR)\main.obj"	"$(INTDIR)\main.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\changeinfo\upload.c

"$(INTDIR)\upload.obj"	"$(INTDIR)\upload.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=.\capabilities.c

"$(INTDIR)\capabilities.obj"	"$(INTDIR)\capabilities.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\cookies.c

"$(INTDIR)\cookies.obj"	"$(INTDIR)\cookies.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\forkthread.c

"$(INTDIR)\forkthread.obj"	"$(INTDIR)\forkthread.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\i18n.c

"$(INTDIR)\i18n.obj"	"$(INTDIR)\i18n.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\iconlib.c

"$(INTDIR)\iconlib.obj"	"$(INTDIR)\iconlib.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_avatar.c

"$(INTDIR)\icq_avatar.obj"	"$(INTDIR)\icq_avatar.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_clients.c

"$(INTDIR)\icq_clients.obj"	"$(INTDIR)\icq_clients.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_fieldnames.c

"$(INTDIR)\icq_fieldnames.obj"	"$(INTDIR)\icq_fieldnames.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_http.c

"$(INTDIR)\icq_http.obj"	"$(INTDIR)\icq_http.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_infoupdate.c

"$(INTDIR)\icq_infoupdate.obj"	"$(INTDIR)\icq_infoupdate.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_packet.c

"$(INTDIR)\icq_packet.obj"	"$(INTDIR)\icq_packet.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_rates.c

"$(INTDIR)\icq_rates.obj"	"$(INTDIR)\icq_rates.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_server.c

"$(INTDIR)\icq_server.obj"	"$(INTDIR)\icq_server.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_servlist.c

"$(INTDIR)\icq_servlist.obj"	"$(INTDIR)\icq_servlist.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_xstatus.c

"$(INTDIR)\icq_xstatus.obj"	"$(INTDIR)\icq_xstatus.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\icq_xtraz.c

"$(INTDIR)\icq_xtraz.obj"	"$(INTDIR)\icq_xtraz.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
...
CPP_SWITCHES=/nologo /MD /W3 /GX /Zi /O1 /I "../../include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "icqoscar8epp_EXPORTS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\icqoscar8epp.pch" /Yc"icqoscar.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 

"$(INTDIR)\icqoscar.obj"	"$(INTDIR)\icqoscar.sbr"	"$(INTDIR)\icqoscar8epp.pch" : $(SOURCE) "$(INTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
CPP_SWITCHES=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "icqoscar8epp_EXPORTS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\icqoscar8epp.pch" /Yc"icqoscar.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
"$(INTDIR)\md5.obj"	"$(INTDIR)\md5.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\stdpackets.c

"$(INTDIR)\stdpackets.obj"	"$(INTDIR)\stdpackets.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\tlv.c

"$(INTDIR)\tlv.obj"	"$(INTDIR)\tlv.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"


SOURCE=.\utilities.c

"$(INTDIR)\utilities.obj"	"$(INTDIR)\utilities.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\icqoscar8epp.pch"
